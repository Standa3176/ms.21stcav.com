...
Last activity: 2026-05-27 - Completed quick task 260527-sgp: "Sourcing gaps" view (competitor-listed parts no supplier carries + we don't sell) + cost counters now exclude no-supplier products (status='publish'). Committed local (23c8632); pending push + deploy + visual check

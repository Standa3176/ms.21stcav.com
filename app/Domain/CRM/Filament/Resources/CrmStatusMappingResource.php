...
class CrmStatusMappingResource extends Resource
{
    ...
    // 260710-pdw — explicit correct-casing label (was auto-humanized 'Crm Status Mappings').
    protected static ?string $navigationLabel = 'CRM Status Mappings';

    // 260710-pdw — de-collided within Settings (was 20, colliding with Alert Recipients). Now 40.

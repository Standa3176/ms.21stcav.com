 ...
 *
 * /admin/horizon/silenced-jobs — lists silenced jobs via
 * JobRepository::getSilenced(). Mirrors Horizon's own
 * SilencedJobsController decode shape.
 *
 * Admin-only.
 */
class HorizonSilencedJobsPage extends Page
{
    ...
    protected static ?string $slug = 'horizon/silenced-jobs';

    protected static ?string $title = 'Silenced Jobs';

    protected static string $view = 'filament.pages.horizon.silenced-jobs';
    ...
    public function getJobs(): Collection
    {
        ...
        return collect(app(JobRepository::class)->getSilenced(-1))
    ...
    public function getTotal(): int
    {
        ...
        return (int) app(JobRepository::class)->countSilenced();
    }
}
